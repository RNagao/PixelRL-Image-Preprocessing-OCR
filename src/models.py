...
class FCN(nn.Module):
    def __init__(self, 
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(in_channels=num_channels, out_channels=hidden_units, kernel_size=3, stride=1, padding=(1, 1), bias=True),
            nn.ReLU(),
            nn.Conv2d(in_channels=hidden_units, out_channels=hidden_units, kernel_size=3, stride=1, padding=(2, 2), dilation=2, bias=True),
            nn.ReLU(),
            nn.Conv2d(in_channels=hidden_units, out_channels=hidden_units, kernel_size=3, stride=1, padding=(3, 3), dilation=3, bias=True),
            nn.ReLU(),
            nn.Conv2d(in_channels=hidden_units, out_channels=hidden_units, kernel_size=3, stride=1, padding=(4, 4), dilation=4, bias=True),
            nn.ReLU(),
        )
        self.diconv1_p = nn.Conv2d(in_channels=hidden_units, out_channels=hidden_units, kernel_size=3, stride=1, padding=(3, 3), dilation=3,
                                   bias=True)
        self.diconv2_p = nn.Conv2d(in_channels=hidden_units, out_channels=hidden_units, kernel_size=3, stride=1, padding=(2, 2), dilation=2,
                                   bias=True)
        self.policy = nn.Conv2d(in_channels=hidden_units, out_channels=self.action_n, kernel_size=3, stride=1, padding=(1, 1), bias=True)

        self.diconv1_v = nn.Conv2d(in_channels=hidden_units, out_channels=hidden_units, kernel_size=3, stride=1, padding=(3, 3), dilation=3,
                                   bias=True)
        self.diconv2_v = nn.Conv2d(in_channels=hidden_units, out_channels=hidden_units, kernel_size=3, stride=1, padding=(2, 2), dilation=2,
                                   bias=True)
        self.value = nn.Conv2d(in_channels=hidden_units, out_channels=1, kernel_size=3, stride=1, padding=(1, 1), bias=True)
